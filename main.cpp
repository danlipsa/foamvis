 ...
 * @mainpage FoamVis 
 *
 * FoamVis provides techniques for exploration, visualization, and
 ...
 * href="modules.html">Modules</a>. For a detailed description of the
 * features available and the motivation behind them see our <a target="_top"
 * href="http://csgalati.swansea.ac.uk/research/">list of
 * publications</a>.
 *
